    ...
    <div class="pt-20">
        <div class="pt-4 pb-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="<?php echo e(route('domains.index')); ?>" class="flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 border border-white/10 text-white/60 hover:text-white rounded-xl font-medium transition text-sm">
                        ...
                        <div class="flex items-center gap-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl px-5 py-4 opacity-70 hover:opacity-100 transition">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center gap-3 mb-1">
                                    <div class="w-2.5 h-2.5 rounded-full flex-shrink-0" style="background-color: <?php echo e($domain->color); ?>;"></div>
                                    <h3 class="text-sm font-medium text-white truncate"><?php echo e($domain->name); ?></h3>
                                ...
                                <div class="flex items-center gap-3 text-xs text-white/30">
                                    <span class="flex items-center gap-1.5">
                                        ...
                                        Deleted <?php echo e($domain->deleted_at->diffForHumans()); ?>
                            ...
                            <div class="flex items-center gap-2 flex-shrink-0">
                                <form action="<?php echo e(route('domains.restore', $domain->id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                ...
                                <form action="<?php echo e(route('domains.forceDelete', $domain->id)); ?>" method="POST" onsubmit="return confirm('Permanently delete this domain and ALL its concepts? This cannot be undone.');">
                                    <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\pc\Desktop\learn php\htdocs\Interview_Prep\interviewprep\resources\views/domains/trash.blade.php ENDPATH**/ ?>