        ...
        <div class="pb-8 flex justify-center">
            <div class="max-w-xl w-full">
                <div class="bg-white/5 backdrop-blur-sm border border-white/50 rounded-2xl p-8">
                    <form method="POST" class="w-full" action="<?php echo e(route('domains.store')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="flex items-center gap-4">
                                <input type="color" name="color" id="colorPicker" value="<?php echo e(old('color', '#6366F1')); ?>"
                                    class="w-14 h-14 rounded-xl cursor-pointer border-0 bg-transparent">
                                <input type="text" id="colorInput" value="<?php echo e(old('color', '#6366F1')); ?>"
...
<?php endif; ?><?php /**PATH C:\Users\pc\Desktop\learn php\htdocs\Interview_Prep\interviewprep\resources\views/domains/create.blade.php ENDPATH**/ ?>