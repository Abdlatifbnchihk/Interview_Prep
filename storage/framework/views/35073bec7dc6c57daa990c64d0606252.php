...
<?php $component->withAttributes([]); ?>
    <div class="pt-20">
        <div class="pt-4 pb-10">
            <a href="<?php echo e(route('concepts.index')); ?>" class="inline-flex items-center gap-2 text-white/50 hover:text-white transition text-sm mb-5">
            ...
            <div class="flex justify-center flex-col items-center">
                <h1 class="text-2xl font-bold text-white mb-1">Create New Concept</h1>
                <p class="text-white/50 text-sm">Add a new concept to your collection</p>
            </div>
        </div>
        ...
        <div class="pb-8 flex justify-center">
            <div class="max-w-xl w-full">
                <div class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                    <form method="POST" action="<?php echo e(route('concepts.store')); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-6">
                            ...
                            <select id="domain_id" name="domain_id" required
                                ...
                                <option value="" class="text-gray-800">Select a domain</option>
                                <?php $__currentLoopData = $domains; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $domain): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($domain->id); ?>" <?php echo e(old('domain_id') == $domain->id ? 'selected' : ''); ?> class="text-gray-800">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="title" name="title" value="<?php echo e(old('title')); ?>" required autofocus
                                ...
                                placeholder="e.g., Eloquent Relationships">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="explanation" name="explanation" rows="5" required
                                class="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:outline-none focus:border-indigo-500 transition resize-none"
                                placeholder="Explain this concept in detail..."><?php echo e(old('explanation')); ?></textarea>
                            ...
                            <div>
                                ...
                                <select id="difficulty" name="difficulty" required
                                    ...
                                    <?php $__currentLoopData = \App\Enums\ConceptDifficulty::cases(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $diff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($diff->value); ?>" <?php echo e(old('difficulty') == $diff->value ? 'selected' : ''); ?> class="text-gray-800">
                            ...
                            <div>
                                ...
                                <select id="status" name="status" required
                                    ...
                                    <?php $__currentLoopData = \App\Enums\ConceptStatus::cases(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($status->value); ?>" <?php echo e(old('status') == $status->value ? 'selected' : ''); ?> class="text-gray-800">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex gap-4 pt-2">
                            <a href="<?php echo e(route('concepts.index')); ?>" class="flex-1 px-6 py-3 text-center text-white/70 hover:text-white bg-white/5 hover:bg-white/10 rounded-xl transition">
                                Cancel
                            </a>
...
<?php endif; ?><?php /**PATH C:\Users\pc\Desktop\learn php\htdocs\Interview_Prep\interviewprep\resources\views/concepts/create.blade.php ENDPATH**/ ?>