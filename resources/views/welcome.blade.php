        ...
        <main class="flex-1 container mx-auto px-6 py-8">
            @auth
                <div class="mb-8">
                    ...
                    <p class="text-white/60">Manage your interview preparation domains</p>
                </div>
                ...
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-xl font-semibold text-white/90">Your Domains</h2>
                    <a href="{{ route('domains.create') }}" class="flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-medium transition text-sm">
