<x-app-layout>
    <div class="pt-20">
        <div class="pt-4 pb-10">
            <a href="{{ route('domains.index') }}" class="inline-flex items-center gap-2 text-white/50 hover:text-white transition text-sm mb-5">
                ...
                <div class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                    <form method="POST" action="{{ route('domains.update', $domain) }}">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $domain->name) }}" required autofocus
                        ...
                        <div class="mb-8">
                            ...
                            <div class="flex items-center gap-4">
                                <input type="color" name="color" id="colorPicker" value="{{ old('color', $domain->color) }}"
