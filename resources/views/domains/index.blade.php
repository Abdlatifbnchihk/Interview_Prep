            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex items-center gap-3">
                    @if (isset($trashCount) && $trashCount > 0)
                        <a href="{{ route('domains.trash') }}" class="flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 border border-white/10 text-white/60 hover:text-white rounded-xl font-medium transition text-sm" title="View trash">
                    ...
                    @endif
                    <a href="{{ route('domains.create') }}" class="flex items-center gap-2 px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-medium transition text-sm shadow-lg shadow-indigo-500/20">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="p-5">
                                <div class="flex items-start justify-between mb-4">
                                    ...
                                    <div class="flex gap-1 opacity-0 group-hover:opacity-100 transition">
                                        ...
                                        <form action="{{ route('domains.destroy', $domain) }}" method="POST" onsubmit="return confirm('Move this domain to trash?');">
                                            @csrf
                                            @method('DELETE')
